      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4">
        ...
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-medium text-gray-900">Eliminar Familia</h2>
              <p className="text-sm text-gray-500">
                ¿Estás seguro de que deseas eliminar la familia <strong>{product.name}</strong>? Esta acción no se puede deshacer.
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm text-yellow-700 mt-1">
                    Esta acción eliminará permanentemente la familia.
