...
const EditTemplateModal: React.FC<EditTemplateModalProps> = ({
  ...
  useEffect(() => {
    if (template && isOpen) {
      ...
      setValue('purchase_price', template.purchase_price ?? null);
      setValue('productId', template.productId || template.product_id);
  ...
  const onSubmit = async (data: EditProductTemplateForm) => {
    ...
    try {
      ...
      const processedData = {
        ...data,
        productId: template.productId || template.product_id
      };
